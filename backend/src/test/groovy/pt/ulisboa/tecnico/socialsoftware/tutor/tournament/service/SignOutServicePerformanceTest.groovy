...
@DataJpaTest
class SignOutServicePerformanceTest extends Specification{
    ...
    def "valid course Execution"() {
        ...
        tournamentDto.setId(1)
        tournamentDto.setAssessmentDto(assdto)
        1.upto(5, {tournamentService.createTournament(courseExecution.getId(), tournamentDto)})
        1.upto(5, {tournamentService.enrollStudent(courseExecution.getId(), STUDENT.getUsername(), it)})

        when:
        1.upto(5, {tournamentService.unrollStudent(STUDENT.getUsername(), it)})
