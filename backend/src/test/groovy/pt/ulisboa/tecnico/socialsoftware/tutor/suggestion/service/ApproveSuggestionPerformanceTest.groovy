...
@DataJpaTest
class ApproveSuggestionPerfomanceTest extends Specification{
    ...
    def "testing approving 3000 suggestions"() {
        ...
        when: "3000 suggestions get approved"
        for (int i = 1; i <= 3000; i++) {
            sugDto.setKey(i)
            suggestionService.approveSuggestion(course.getId(), sugDto, userTDto)
        }
